...
(5) Open in the browser: `http://localhost/projectile-data-lab/projectile-data-lab_en.html` (You will probably need to modify this
...
(3) Open in the
browser: `http://localhost/projectile-data-lab/build/adapted-from-phet/projectile-data-lab_en_adapted-from-phet.html` (You will
