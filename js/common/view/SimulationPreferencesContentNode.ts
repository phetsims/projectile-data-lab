...
export default class SimulationPreferencesContentNode extends PreferencesPanelContentNode {
  ...
  public constructor( tandem: Tandem ) {
    ...
    const binTypeRadioButtonGroup = new PDLPanel( new VerticalAquaRadioButtonGroup<BinStrategy>( PDLPreferences.binStrategyProperty, [ {
    ...
    const autoGenerateDataControl = new PreferencesControl( {
      ...
      controlNode: new Checkbox( PDLPreferences.autoGenerateDataProperty,
    ...
    const projectileTypeAffectsSpeedControl = new PreferencesControl( {
      ...
      controlNode: new Checkbox( PDLPreferences.projectileTypeAffectsSpeedProperty,
